...
%>
    ...
    <section style="padding:70px 0px;">
		...
		<div class="container col-lg-5">
		  ...
		  <form action="updatePackage" method="post" class="px-4 py-3" enctype = "multipart/form-data">
		  
		    <fieldset>
		    
		    <div class="form-group py-4">
		     <h3><b>Update Package</b></h3>
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <img alt="" src="img/<%= pImage %>" width="560" height=auto><br>
		    
		      <input class="btn btn-success btn-lg" type="submit" name="update" value="Update">
		      </div>
