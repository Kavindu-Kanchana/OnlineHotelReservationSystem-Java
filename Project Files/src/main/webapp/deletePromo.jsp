   ...
   <a class="navbar-brand" href="adminView.jsp"><img src="img/logo.png" width=150px></a>
    ...
    <section style="padding:80px 0px;">
		<div class="container col-lg-5">
		  <form action="deletePromo" method="post" class="px-4 py-3" >
		    ...
		    <div class="form-group">
		      ...
		      <input type="text" id="pCode" class="form-control" name="promoCode" size="10" readonly pattern="[a-zA-Z0-9-]+"  value="<%= pCode %>">
		      ...
		      <input type="text" class="form-control" id="amount" name="amount" pattern="[0-9]{2}" readonly value="<%= amount %>"><br>
		    </div><br>
		    <input id="submit-btn" class="btn btn-danger" type="submit" name="delete" value="Delete">
		  </form>
		  </div>
	</section>
