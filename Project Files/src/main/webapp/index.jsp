	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item drk active">
	      ...
	      <div class="carousel-caption d-none d-md-block">
	        ...
	        <p>A Fascinating Hotel located in the heart of Kandy Sri Lanka.</p>
	      </div>
	    </div>
    ...
    <div class="card mb-3  bg-light bg-gradient" >
    	...
    	<div class="col">
	      <div class="card-body">
	        ...
	        <p class="card-text"><small class="text-muted">Lavishly complementing the luxury accommodation at Hotel ABC, our 
	...
	<!-- card2 -->
	 <div class="card mb-3  bg-light bg-gradient"" >
	  <div class="row g-0">
	    ...
	    <div class="col">
	      <div class="card-body">
	        <h3 class="card-title">Hotel ABC</h3>
	        <p class="card-text"><small class="text-muted">The Hotel is ideally located for business and entertainment and provides you easy access to all renowned sights of the City.
	         Adjacent to the Hotel that features an array of branded shops with diverse products. It also includes a Food Emporium, VR Centre and a 9D Cinema to enjoy a fun-filled and active stay.
</small></p>
	      </div>
	    </div>
	    <div class="col">
